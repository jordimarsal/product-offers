...
/**
 * Populate MDC with the incoming `x-correlator` header for the duration of the request.
 * Ensures MDC is cleared after the request completes so correlator is available to
 * controller, service and exception handlers during processing.
 */
@Component
