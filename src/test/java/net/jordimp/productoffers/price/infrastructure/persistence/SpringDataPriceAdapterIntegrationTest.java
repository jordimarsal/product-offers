...
class SpringDataPriceAdapterIntegrationTest {
    ...
    void adapterDelegatesToRepository_andReturnsBestPrice() {
        // repository is pre-populated via src/main/resources/data.sql for tests; do not insert duplicates
        ...
        var list = repository.findByBrandIdAndProductIdAndStartDateLessThanEqualAndEndDateGreaterThanEqualOrderByPriorityDesc(
