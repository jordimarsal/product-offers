...
class ProductOffersServiceTests {
    ...
    @InjectMocks private ProductOffersServiceImpl service;

    @Mock private PriceRepositoryPort pricesRepository;
    ...
    void testGetInquiryPrices(
            LocalDateTime applicationDate, Long productId, Long brandId, Long expectedPriceList) {
        // When
        when(pricesRepository.findBestPrice(brandId, productId, applicationDate))
                .thenReturn(
                        Optional.ofNullable(
    ...
    void testGetInquiryPricesErrorCases(
        ...
        // Then
        net.jordimp.productoffers.price.domain.exceptions.PriceNotFoundException exception =
                assertThrows(
                        net.jordimp.productoffers.price.domain.exceptions.PriceNotFoundException
                                .class,
                        () ->
                                service.getInquiryPrices(
                                        "correlator", applicationDate, productId, brandId));
