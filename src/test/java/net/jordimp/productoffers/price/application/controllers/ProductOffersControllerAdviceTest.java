...
@WebMvcTest(controllers = ProductOffersController.class,
    ...
    excludeFilters = @org.springframework.context.annotation.ComponentScan.Filter(
        ...
        classes = net.jordimp.productoffers.price.infrastructure.persistence.SpringDataPriceAdapter.class
    )
)
class ProductOffersControllerAdviceTest {
    ...
    @MockBean
    private SpringDataPriceAdapter springDataPriceAdapter;
    ...
    @Test
    void whenServiceThrowsResponseStatusException_thenControllerAdviceUsesReason() throws Exception {
        LocalDateTime applicationDate = LocalDateTime.of(2020,6,14,10,0);
        when(productOffersService.getInquiryPrices("correlator", applicationDate, 35455L, 1L))
